# AOMDD4CPS
A tool designed to implement an Agent-Oriented Model-Driven Development (AOMDD) process for Cyber-Physical Systems (CPS), enabling automated model transformation and code generation to streamline CPS development. For more details, see the [process overview documentation](MDD4CPS_process_overview.md).
